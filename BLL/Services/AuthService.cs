...
namespace BLL.Services
{
    ...
    public class AuthService
    {
        ...
        /// <param name="username">Tên người dùng</param>
        /// <param name="password">Mật khẩu (dạng text thô)</param>
        /// <returns>Trả về đối tượng Users nếu đăng ký thành công, null nếu tên đã tồn tại.</returns>
        public Users Register(string username, string password)
        {
            try
            {
                ...
                return newUser; // Đăng ký thành công, trả về user mới
            }
            catch (Exception ex)
            {
                Console.WriteLine(ex.Message);
                return null; // Đăng ký thất bại do lỗi
            }
        }
