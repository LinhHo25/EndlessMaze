...
namespace Main
{
    public partial class frmMenu : System.Windows.Forms.Form
    {
        ...
        public frmMenu(PlayerCharacter character, PlayerSessionInventory inventory, CalculatedStats stats, GameSessionService gameSessionService, int currentHealth)
        {
            InitializeComponent();
