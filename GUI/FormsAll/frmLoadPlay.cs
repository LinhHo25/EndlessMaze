...
namespace Main
{
    public partial class frmLoadPlay : System.Windows.Forms.Form
    {
        ...
        // --- SỬA: Đổi User thành Users (số nhiều) ---
        public frmLoadPlay(frmMain mainForm, User user)
        {
            InitializeComponent();
            _mainForm = mainForm;
            _user = user; // Lưu User
        ...
        private void LoadCharacters()
        {
            ...
            {
                // Gọi BLL
                List<PlayerCharacter> characters = _characterService.GetCharactersByUserId(_user.UserID);
        ...
        private void ListViewSaves_DoubleClick(object sender, EventArgs e)
        {
            ...
            if (listViewSaves.SelectedItems.Count > 0)
            {
                ...
                PlayerCharacter selectedChar = listViewSaves.SelectedItems[0].Tag as PlayerCharacter;
